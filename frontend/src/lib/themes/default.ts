...
// Common color system used by both themes
const colors = {
...
export const DEFAULT_LIGHT_THEME: Theme = {
  id: 'luminous',
  name: 'Luminous',
  description: 'The default light theme for Portfolia',
  mode: 'light',
  isBuiltIn: true,
  ...
  settings: {
    colors,
    semantic: createSemanticColors(colors, 'light'),
    typography,
    spacing,
    borderStyles,
    shadows,
...
export const DEFAULT_DARK_THEME: Theme = {
  id: 'cosmic',
  name: 'Cosmic',
  description: 'The default dark theme for Portfolia',
  mode: 'dark',
  isBuiltIn: true,
  createdAt: '2025-01-01T00:00:00.000Z',
  updatedAt: '2025-01-01T00:00:00.000Z',
  settings: {
    colors,
    semantic: createSemanticColors(colors, 'dark'),
    typography,
    spacing,
    borderStyles: {
      ...borderStyles,
      // Slightly adjust border radius for dark mode
      radius: {
        ...borderStyles.radius,
        DEFAULT: '0.3rem',
        md: '0.4rem',
